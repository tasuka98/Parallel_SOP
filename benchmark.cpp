...
int main() {
    ...
    for (int i = 0; i < 26; i++) {
        ...
        string command_third = "./main_sequential ./mibench/" + Compiler[i] + " 7200 1237935";
        cout << endl;
    ...
    for (int i = 0; i < 13; i++) {
        ...
        string command_third = "./main_sequential ./tsplib/" + TSPLIB[i] + " 7200 1237935";
        cout << endl;
        system(command_first.c_str());
        system(command_second.c_str());
        system(command_third.c_str());
    ...
    for (int i = 0; i < 16; i++) {
        ...
        string command_third = "./main_sequential ./soplib/" + SOPLIB[i] + " 7200 1237935";
        cout << endl;
        system(command_first.c_str());
        system(command_second.c_str());
        system(command_third.c_str());
